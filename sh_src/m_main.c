 ...
 *
 * Generated by a preprocessor-aware census against the .build_flags
 * SH-2 half; "LIVE" = the guard evaluates true on the line, "probe" =
 * only under a flag the line does not carry. A site's guard, not its
 * comment, decides.
 *
